// ascii_slug('Phạm Giang Pro'); => pham giang pro
// ascii_slug('Phạm Giang Pro','LW'); => Pham Giang Pro
// ascii_slug('Phạm Giang Pro','UP'); => PHAM GIANG PRO
function AsciiSlug(str, format) {
  ...
  if (format == 'LW') {
    str = str.replace(/-/g, ' ').capitalize(); // Viết hoa ký tự đầu mỗi chữ
